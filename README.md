...
# For Wayland Users
This mod supports centering the cursor on wayland using [ydotool](https://github.com/ReimuNotMoe/ydotool) or [wdotool](https://github.com/cushycush/wdotool), to enable this feature, you need to configure them properly, here are the basic setup steps:
## ydotool
...
Once configured, you can use this tool as the backend of the mod by specifying the JVM argument `-DuseWdotool=<backend>`, where `<backend>` is based on your [compositor](https://github.com/cushycush/wdotool#backends).
